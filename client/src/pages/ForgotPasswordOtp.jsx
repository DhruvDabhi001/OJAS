...
//   const sendOtp = async () => {
//     try {
//       await axios.post(`https://ojas-backend.onrender.com/api/auth/forgot-password`, {
//         email,
//         newPassword,
//       });
...
//     try {
//       await axios.post(`https://ojas-backend.onrender.com/api/auth/verify-otp`, {
//         email,
//         otp,
//       });
